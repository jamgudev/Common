...
public class RoundedImageView extends AppCompatImageView {
    ...
    public static final float DEFAULT_RADIUS = 5.0f;//dp
    ...
    private boolean onlyRoundTop, onlyRoundBottom;
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        int cornerRadius = a.getDimensionPixelSize(R.styleable.RoundedImageView_corner_radius, -1);
        onlyRoundTop = a.getBoolean(R.styleable.RoundedImageView_only_round_top, false);
        onlyRoundBottom = a.getBoolean(R.styleable.RoundedImageView_only_round_bottom, false);
    ...
    private void initCornerRadius(int cornerRadius) {
        this.cornerRadius = cornerRadius;

        // don't allow negative values for radius and border
        if (cornerRadius < 0) {
            this.cornerRadius = WidgetExtensionKt.dp2px(DEFAULT_RADIUS, getContext());
        }
    }
    ...
    private void updateAttrs(Drawable drawable) {
        ...
        if (drawable instanceof RoundedDrawable) {
            ((RoundedDrawable) drawable)
                    ...
                    .setOval(isOval)
                    .setOnlyRoundTop(onlyRoundTop)
                    .setOnlyRoundBottom(onlyRoundBottom);
